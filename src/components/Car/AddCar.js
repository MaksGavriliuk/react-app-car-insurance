...
export default function AddCar() {
    ...
    return (
        <>
            <Header />
            <div className="car-modal" style={{ width: '600px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Form form={form} onFinish={handleAddCar}>
                        <Form.Item name="selectedBrand" rules={[{ required: true, message: 'Введите марку' }]}>
                            <Select placeholder="Выберите марку" style={{ width: '200px' }} onChange={handleBrandChange}>
                                {brands &&
                                    brands.map((brand) => (
                        ...
                        <Form.Item name="selectedCurrentValue" rules={[{ required: true, message: 'Введите текущую стоимость' }]}>
